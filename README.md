...
✅ **C++** — полностью готов  
✅ **Go** — полностью готов  
⚠️ **Rust** — ведется активная разработка 
...
Rust-версия полностью готова по логике и структурам,
но для финальной отправки транзакций необходимо подключение tonlib-rs —
официальной библиотеки TON для Rust.

После интеграции sendTransaction() будет работать идентично другим языкам.
...
Обновления:
-	Добавлены реализации для всех 5 языков
