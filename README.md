...
Поддерживает 8 языков программирования и единый API-протокол, что позволяет использовать готовую логику на любой платформе.
...
Обновления:
-  Добавлены реализации для всех 8 языков  
